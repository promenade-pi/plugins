 ...
 *     Discovery is a wasm kernel behind an internal OCPN/OC-DFG stage; it
 *     cannot describe a half-finished metro map, so there is nothing
 *     truthful to draw *of the result*. A standby animation plus the run's
 *     own progress message is the honest maximum.
 ...
 *     (see `plugin.tsx`), and on a large one that pass is seconds long with
 *     the panel already on screen — which is what showed as a blank white
 *     view.
 *
