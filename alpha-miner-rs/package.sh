...
cp pkg/promenade_alpha_miner.js "$OUT/stage/"
cp pkg/promenade_alpha_miner_bg.wasm "$OUT/stage/"
[ -f README.md ] && cp README.md "$OUT/stage/" || true
[ -f CHANGELOG.md ] && cp CHANGELOG.md "$OUT/stage/" || true
# Documentation ships with the package: a docs/ folder and any images in it.
