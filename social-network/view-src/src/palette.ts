 ...
 * survive a re-sort, a change of metric, and the edge cut, so the same person
 * is the same colour in the graph and in the matrix beside it. The cost is
 * that two names can collide; with a dozen colours and tens of people that is
